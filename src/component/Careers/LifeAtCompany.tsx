    ...
    <section className="py-24 bg-slate-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
           <div>
             <p className="text-blue-400 font-bold uppercase tracking-widest text-sm mb-2">Our Culture</p>
             <h2 className="text-4xl font-heading font-black text-white">Life at SolarReios</h2>
           </div>
           <p className="text-slate-400 max-w-md md:text-right font-light text-lg">Transparency, innovation, and a shared passion for a greener world define our workplace.</p>
        </div>

        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 h-[600px]">
          <div className="col-span-2 row-span-2 rounded-[40px] overflow-hidden group border border-white/10 shadow-2xl">
          ...
          <div className="rounded-[40px] overflow-hidden group border border-white/10 shadow-2xl">
          ...
          <div className="col-span-2 rounded-[40px] overflow-hidden group h-[280px] border border-white/10 shadow-2xl">
